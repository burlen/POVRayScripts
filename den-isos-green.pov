...
camera {
  ...
  #declare CloudsMap = pigment { image_map{ jpeg concat(ScriptRoot, "earthhiresclouds4K.jpg") once map_type 2 } }
  ...
  #declare MoonTex = texture {
    ...
    normal { bump_map { jpeg concat(ScriptRoot, "moonbump4k.jpg") once map_type 2 bump_size MoonBump } }
  ...
  sphere {
    0, 5000
    hollow
    pigment { image_map { png concat(ScriptRoot, "milky-way.png") once map_type 1 } }
